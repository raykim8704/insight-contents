...
LEMPCore.System.getGPS = function()
{
    ...
    var tr = {
            ...
            param:{
            	callback:callback,
		reload : arguments[0]._bReload //Insight only, 안드로이드 좌표 못얻어올 경우 대비
            }
    };
...
LEMPCore.EventManager.list = new Array("ready","resume","backbutton","open","close","networkstatechange","push");
...
LEMPCore.DeviceManager.init = function(){
	...
	if(LEMP.Device.Info.web_log_level) {
		LEMPCore.loglevel =  LEMP.Device.Info.web_log_level;
	}
